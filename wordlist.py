# Code from tzachyrm on GH - https://github.com/icode-co-il/hebrew-word-list
# -*- coding: utf-8 -*-
...
INVALID_FILENAME_PATTERN = re.compile(r'\.(jpg|png)\.html$|שיחת_משתמש|תמונה')  # ur instead of r in src
PARAGRAPHS_PATTERN = re.compile(r"<p>(.*?)</p>")
CHARS_PATTERN = re.compile(r"""[^אבגדהוזחטיכלמנסעפצקרשתןףץםך'\-\s"]""")  # ur instead of r in src
...
for i, file_path in enumerate(all_files):
	print(i/len(all_files))  # makeshift progressbar
